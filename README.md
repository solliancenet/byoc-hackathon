...
> [!NOTE] At this point, it is a good moment to clone this repository to your local machine. You can do this by running the following command in your terminal or command prompt:
...
> [!NOTE] For the purpose of this hackathon, we recommend that you choose the Azure Container Apps (ACA) option which is the quickest to deploy.

> [!IMPORTANT] Before you proceeed, make sure you review the prerequisites list and you deploy them.
